...
I've now fully completed the project.  To run it, you first do cd final_project, then cd Final_Project, and then just run main.py through python3 main.py (this is because I accidentally created a file within a file and havent figured out how to safely undo this).  Its current functions are centered around a self-assesment rating system.  It asks you about your physical abilities, squash skills, and mental game.  For each category, it will ask you to rate different aspects within them 1-5.  This is later used to create a structured program that could (if chosen) prioritize training your weaknesses.  After that, it will ask what your goal is with this program.  Whether its to maintain, build upon flaws, or prepare for a competition, the program will adapt to your preferences.  To fully flesh out your schedule, it will ask you to enter the number of rest days you'll be taking and when during your chosen amount of weeks for this training block.  After that, I've implented the rich python library that allows me to print out the schedule in a table-like format, which is best for this form of content.  Then, you will have your personalized squash training program, with three sessions a day, created to your liking.  On top of that, based on how strenous or what activities occur each day, it will reccomend a nutrition plan to keep up with the choices you previously made for the style of your training program.  These suggestions will be displayed on the right most side of the table.  When the full schedule for every week has been printed in the terminal, you will get a little message at the bottom of your last week saying that your training plan has been uploaded to training_plan.csv.  This file makes it easy for users to transfer their schedule into something like excel or google sheets.  All you need to do is download the training_plan.csv file and then open it will excel or sheets.  It should upload cleanly and in a similar format to how its displayed in the terminal.

    Rich library was found online.  

    Ai used to implement rich library, and used to develop code for the randomization process and math involved.
