...
import random
from workouts import fitness_workouts, squash_drills, mental_training, nutrition_plan
...
#Create weighted list favoring weaknesses
...
#Avoid repeating same choice three times
...
#Select random drill from category
...
#Determine training type by day index
...
#Build one day’s full training plan
def generate_day(day_index, phys_pool, squash_pool, mental_pool,
    ...
    if session_type == "Recovery":
        return session_type, {
            "Morning": pick_from_category("injury_prevention", "fitness"),
            "Afternoon": pick_from_category("consistency", "squash"),
            "Evening": pick_from_category("resilience", "mental"),
            "Nutrition": nutrition_plan["Recovery"]
            }
    ...
    # ---------------------------
    return session_type, {
    "Morning": pick_from_category(phys, "fitness"),
    "Afternoon": pick_from_category(squash_category, "squash"),
    "Evening": pick_from_category(mental, "mental"),
    "Nutrition": nutrition_plan.get(session_type, "Balanced diet")
}
...
#Generate multi-week training program
